...
st.markdown(
    ...
    <div class="title "style="font-size: 20px; font-weight: bold; color: #333;">By Bruno Manzano and Paula Mateos - Analítica Visual 2024</div>
    """,
    unsafe_allow_html=True,
)
...
""")
st.markdown("""
<div class="title "style="font-size: 20px; font-weight: bold; color: #333;">Objectives of the Project</div>
""",    unsafe_allow_html=True,
)
...
st.markdown("""
<div class="title "style="font-size: 20px; font-weight: bold; color: #333;">About the Dataset</div>
""",    unsafe_allow_html=True,
)
st.markdown("""
